...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: buchung_uebersicht.php?gast_id=$gast_id&stellplatz_id={$_POST['stellplatz_id']}&anreise_datum={$_POST['anreise_datum']}&abreise_datum={$_POST['abreise_datum']}&erwachsene={$_POST['erwachsene']}&kinder={$_POST['kinder']}&tier={$_POST['tier']}&wasser={$_POST['wasser']}&strom={$_POST['strom']}");
        exit;
    } else {
